...
C     the commonblock for the laserfield
      ...
      real*8 ezero1, ezero2,estep
      real*8 freq1,freq2,fstep,tpulse
      real*8 ezero,freq
...
10    format (//1x,'Laser Parameters:',/
     &          1x,'=================',/)
20    format (1x,'Amplitude of laserfield',t40,': ',
     &        d10.4)
30    format (1x,'Frequency of laserfield',t40,': ',
     &        d10.4)
...
C
C     E(t)=E0*cos(wt)*exp(-gamma*(t-tpulse/2)**2)
C     gamma=4*ln2/tpulse**2 
...
C------------------------------------------------------------
     ...
     &          exp(-4.0d0*dlog(2.0d0)*
     &          (2.0d0*time/tpulse-1)**2) 
      return
      end
